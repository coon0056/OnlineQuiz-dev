...
class Short_Answer_Question{
    ...
    function create_post_type(){
        ...
        add_filter('manage_short_answer_question_posts_columns', array($this, 'custom_column_header'));
        add_filter('manage_short_answer_question_posts_custom_column', array($this, 'custom_column_content'), 10,2);
        add_action('save_post', array($this, 'save_question_post'));
        add_shortcode('short_answer_question', array($this, 'short_answer_question_shortcode'));
    }
    ...
    function register_post_type(){
        ...
        $question_labels = array(
            ...
            'singular_name'      => 'Short Answer Question',
            'menu_name'          => 'Short Answer Questions',
            'name_admin_bar'     => 'Short Answer Question',
            'add_new'            => 'Add New',
            'add_new_item'       => 'Add New Short Answer Question',
            'new_item'           => 'New Short Answer Question',
            'edit_item'          => 'Edit Short Answer Question',
            'view_item'          => 'View Short Answer Question',
            'all_items'          => 'All Short Answer Questions',
            'search_items'       => 'Search Short Answer Questions',
            'parent_item_colon'  => 'Parent Short Answer Questions:',
            'not_found'          => 'No Short Answer Questions found.',
            'not_found_in_trash' => 'No Short Answer Questions found in Trash.'
        );
        ...
        register_post_type('short_answer_question', $args);
    }

    //creates the metaboxes 
    function register_meta_boxes(){
        add_meta_box('question_weight_meta','Short Answer Question Weight',array($this, 'question_weight_html'),'short_answer_question');
        add_meta_box('answer_meta', 'Short Answer Question', array($this, 'short_answer_question_html'), 'short_answer_question');
    }
    ...
    function short_answer_question_html($post){
    ...
    function custom_column_content($column_name, $post_id){
        ...
        switch($column_name) {
            ...
            case 'points':
                ...
                break;
            case 'shortcode':
                echo '[short_answer_question id= '.$post_id.']';
                break;
            default:
                break;
        }
    ...
    function short_answer_question_shortcode($atts){
    ...
    public static function short_answer_question_results($questionID, $question, $userAnswers) {
